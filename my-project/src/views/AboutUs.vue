...
<div class="card bg-dark text-white">
  <img src="https://miro.medium.com/max/2056/1*smV1EYFRTT4wGha020XFIA.png" class="card-img" alt="img" >
  <div class="card-img-overlay">
    <h5 class="card-title fs-1 "  >ABOUT US </h5>
    <p class="card-text mt-5 fs-5 "> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae non esse at aliquam consectetur, pariatur ad? Consequuntur deserunt voluptate ipsum temporibus accusamus. Ad accusantium, quod incidunt necessitatibus nesciunt voluptatem ut? </p>
    <p class="card-text mt-5 fs-4 "> Projet VuesJS  </p>
  </div>
</div>
-->
...
<div class="cards cards--two">
  ...
  <div class="cards cards--three">
    <img src="../../public/alexis.png" class="img-responsive" alt="">
    <span class="cards--three__rect-1">
      <span class="shadow-1"></span>
      <p>Majchrzak Alexis</p>
    </span>
